...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-03-2019 a las 23:41:59
...
INSERT INTO `client` (`IdCli`, `NomCli`, `ApeCli`) VALUES
(1, 'Alfonso', 'Duque'),
(2, 'Felipe', ' Martín'),
(3, 'Thomas', 'Edison'),
(4, 'Carlos', 'García'),
...
(19, 'Dynamic Routing Between Capsules', 'A capsule is a group of neurons whose activity vector represents the instantiation parameters of a specific type of entity such as an object or an object part. We use the length of the activity vector to represent the probability that the entity exists and its orientation to represent the instantiation parameters. Active capsules at one level make predictions, via transformation matrices, for the instantiation parameters of higher-level capsules.', 'https://arxiv.org/pdf/1710.09829.pdf', 50, 40, 60, 30, 0, 40, 100);
...
--
ALTER TABLE `paper`
  MODIFY `IdPap` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
COMMIT;
